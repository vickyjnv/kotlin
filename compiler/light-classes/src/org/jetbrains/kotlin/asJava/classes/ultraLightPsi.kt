...
open class KtUltraLightClass(classOrObject: KtClassOrObject, internal val support: UltraLightSupport) :
    ...
    private fun computeMethodName(declaration: KtDeclaration, name: String, type: MethodType = MethodType.Regular): String {

        fun tryCompute(declaration: KtDeclaration, type: MethodType = MethodType.Regular): String? {
