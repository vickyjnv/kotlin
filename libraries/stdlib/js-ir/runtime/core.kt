...
fun toString(o: dynamic): String = when {
    ...
    // js() function is needed here to force exact toString call
...
fun hashCode(obj: dynamic): Int {
    ...
    return when (jsTypeOf(obj)) {
        "object" -> if ("function" === jsTypeOf(obj.hashCode)) js("obj.hashCode()") else getObjectHashCode(obj)
