...
class KotlinCacheServiceImpl(val project: Project) : KotlinCacheService {
    ...
    private inner class GlobalFacade(settings: PlatformAnalysisSettings) {
        ...
        private val librariesContext = sdkContext.contextWithCompositeExceptionTracker()
        ...
        private val modulesContext = librariesContext.contextWithCompositeExceptionTracker()
    ...
    private fun createFacadeForFilesWithSpecialModuleInfo(files: Set<KtFile>): ProjectResolutionFacade {
        ...
        return when {
            specialModuleInfo is ModuleSourceInfo -> {
                ...
                val globalContext = modulesFacade.globalContext.contextWithCompositeExceptionTracker()
            ...
            specialModuleInfo is ScriptDependenciesSourceInfo -> {
                val globalContext = facadeForScriptDependenciesForProject.globalContext.contextWithCompositeExceptionTracker()
                makeProjectResolutionFacade(
